 ...
 */
let heartRate1 : Double = 65, heartRate2 : Double = 70, heartRate3 : Double = 75, addedHR = heartRate1 + heartRate2 + heartRate3, averageHR = addedHR/3
 ...
 */
let tempInFahrenheit = 98.6, tempInCelsius = (tempInFahrenheit - 32) * (5/9)
