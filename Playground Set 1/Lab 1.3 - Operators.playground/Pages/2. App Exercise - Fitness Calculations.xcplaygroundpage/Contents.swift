 ...
 */
let heartRate1 = 65, heartRate2 = 70, heartRate3 = 75, addedHR = heartRate1 + heartRate2 + heartRate3, averageHR = addedHR/3; print(averageHR)
/*:
 ...
 */
let heartRate1D : Double = Double(heartRate1), heartRate2D : Double = Double(heartRate2), heartRate3D : Double = Double(heartRate3), addedHRD = heartRate1D + heartRate2D + heartRate3D, averageHRD = addedHRD/3; print(averageHRD)
/*:
 ...
 */
let steps : Double = 3467, goal : Double = 10000, percentOfGoal = steps/goal
