...
struct User{
    var name: String
    var (activityLevel, age): (Int, Int)
    var (height, weight): (Double, Double)
}

/*:
 Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
 */
var kyle = User(name: "Kyle", activityLevel: 8, age: 21, height: 73, weight: 190 )
print(kyle)
/*:
 ...
 */
struct Distance{
    var (meters, feet): (Double, Double)
    init(Meters meters: Double) {
        self.meters = meters
        self.feet = self.meters / 3.28084
    }
    init(Feet feet: Double) {
        self.feet = feet
 ...
 */
var (mile, meters) = (Distance(Feet: 1600),Distance(Meters: 5249.344))
print(mile)
/*:
