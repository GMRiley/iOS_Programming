...
let favoriteBook = Book(title: "Scrum, the art of doing twice the work in half the time", author: "J.J. Sutherland")
/*:
...
struct Height{
    ...
    init(Inches heightInInches: Double) {
        self.heightInInches = heightInInches
        self.heightInCentimeters = self.heightInInches * 2.54
    }
    init(Centimeters heightInCentimeters: Double){
