 ...
 */
var dollars = 0
print(dollars == 0 ? "Sorry, kid. You're broke!" : "")
 ...
 */
dollars = 10
print(dollars == 0 ? "Sorry, kid. You're broke!" : "You've got some spendig money!")
 ...
 */
dollars = 105
print(dollars == 0 ? "Sorry, kid. You're broke!" : dollars < 100 ? "You've got some spending money!" : "Looks to me like you're rich!")
