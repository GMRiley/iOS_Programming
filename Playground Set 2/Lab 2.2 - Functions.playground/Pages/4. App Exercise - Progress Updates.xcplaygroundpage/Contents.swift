...
func progressUpdate(steps: Int, goal : Int){
    print(Double(steps) < Double(goal) * 0.1 ? "You're off to a good start." : Double(steps) < Double(goal)/2 ? "You're almost halfway there!" : Double(steps) < Double(goal) * 0.9 ? "You're over halfway there" : Double(steps) < Double(goal) ? "You're almost there!" :  "You beat your goal!")
}
for i in 0...5{
    progressUpdate(steps: (1000 * i), goal: 10000)
}
/*:
